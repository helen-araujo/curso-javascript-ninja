(function() {
    ...
    */
    if (sum) {
        number1 = 10;
        number2 = 20;
        console.log(showOperationMessage(operationSignal, number1, number2), operation[operationSignal](number1, number2));
    ...
    */
    ...
    if (sum) {
        number1 = 10;
        number2 = 20;
        console.log(showOperationMessage(subtraction, number1, number2), operation[subtraction](number1, number2));
        console.log(showOperationMessage(division, number1, number2), operation[division](number1, number2));
        console.log(showOperationMessage(multiplication, number1, number2), operation[multiplication](number1, number2));
        console.log(showOperationMessage(mod, number1, number2), operation[mod](number1, number2));
    }
    ...
    */
    var invalido = '!';
    var teste;
    teste = calculator(invalido);
    if (teste) {
        console.log(showOperationMessage(invalido, 10, 20), operation[invalido](10, 20));
    } else {
        console.log("OOperador invalido");
    }
})();